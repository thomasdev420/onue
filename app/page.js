...
export default function Home() {
  return (
    <div className="min-h-screen bg-[#FAF9F6] flex flex-col items-center justify-center px-6 py-12 sm:px-20 font-sans text-gray-900 relative">
      {/* Navigation Bar - Absolutely positioned in top right corner */}
      ...
      <section className="max-w-4xl mx-auto mb-10 p-6">
        <h2 className="text-lg font-semibold text-gray-800 mb-4">Alternatives are expensive.</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-red-50 p-4 rounded-lg border border-red-300">
            <h3 className="text-lg font-semibold text-gray-800 mb-2">UGC Agencies</h3>
            <p className="text-gray-600 mb-2">Expensive, charging $60-$120 per video, going upwards of $4000 to $6000 a month.</p>
            <ul className="text-left text-sm space-y-1">
              ...
              <li className="flex items-center"><span className="text-green-400 mr-2">✔</span> Professional quality</li>
            </ul>
          </div>
          <div className="bg-red-50 p-4 rounded-lg border border-red-300">
            <h2 className="text-lg font-semibold text-gray-800 mb-2">DIY Approach</h2>
            <p className="text-gray-600 mb-2">Time-consuming process: research, plan, record, edit, schedule, iterate, re-purpose, analyze...</p>
            <ul className="text-left text-sm space-y-1">
              ...
              <li className="flex items-center"><span className="text-green-400 mr-2">✔</span> Full creative control</li>
            </ul>
          </div>
          <div className="bg-green-50 p-4 rounded-lg border border-green-300">
            <h3 className="text-lg font-semibold text-gray-800 mb-2">SwiftReel</h3>
            <p className="text-gray-600 mb-2">Automatically creates & publishes videos to all platforms for a simple monthly subscription.</p>
            <ul className="text-left text-sm space-y-1">
              <li className="flex items-center"><span className="text-green-400 mr-2">✔</span> Cost effective</li>
              <li className="flex items-center"><span className="text-green-400 mr-2">✔</span> Fully automated</li>
              <li className="flex items-center"><span className="text-green-400 mr-2">✔</span> Multi-platform publishing</li>
            </ul>
          </div>
        </div>
        <h3 className="mt-6 text-base font-bold text-gray-800">What can it do?</h3>
        <p className="pt-2 text-md font-medium">
          <span className="text-gray-800">SwiftReel&apos;s goal is to automate content that drives traffic to your business. </span>
          <span className="text-gray-600">The differentiating factor between SwiftReel and competitors is that SwiftReel takes the approach of using faceless content to automate videos. While other services require you to upload all of your video & image assets in order to create &quot;AI ads&quot;, SwiftReel believes in organic content with TikTok distribution as a means of getting leads/inbound.</span>
        </p>
      </section>
