...
import { Home, HelpCircle, Settings, ArrowLeft, Menu, Shield, Target, KeyRound, BarChart2 } from 'lucide-react';
        ...
        <div className="flex-1 flex flex-col sidebar-content">
          ...
          <nav className="mt-2 px-4 flex-1">
            <ul className="space-y-1 text-sm">
              ...
              <SidebarLink href="/dashboard/listing-impact" icon={<BarChart2 size={18} />} label="Listing impact" currentPath={pathname} isCollapsed={isCollapsed} />
              <div className="mt-4" />
